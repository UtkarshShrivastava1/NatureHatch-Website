...
import { Clock, User, Calendar, ArrowRight, Search, Filter, BookOpen, Tag, Eye, X, ArrowLeft } from 'lucide-react';
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-gray-600">
                <p>Published on {formatDate(selectedBlog.createdAt)}</p>
      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        {filteredBlogs.length > 0 && (
          <div className="text-center mt-12">
            <button className="bg-green-600 text-white px-8 py-3 rounded-full font-medium hover:bg-green-700 transition-colors hover:scale-105 transform duration-200">
              Load More Articles
            </button>
          </div>
        )}
        ...
        <div className="container mx-auto px-4 text-center">
          <div>
            ...
            <div className="max-w-md mx-auto flex gap-3">
              ...
              />
              <button className="bg-green-800 text-white px-6 py-3 rounded-lg font-medium hover:bg-green-900 transition-colors hover:scale-105 transform duration-200">
                Subscribe
              </button>
            </div>
          </div>
